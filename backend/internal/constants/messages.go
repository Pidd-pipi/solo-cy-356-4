...
const (
	...
	MsgWaitlistJoinOK    = "候补登记成功，可在“我的候补”查看排队位置"
	MsgWaitlistConfirmOK = "确认成功，地块已认养到你名下"
	MsgWaitlistCancelOK  = "已放弃该地块候补"
	MsgWaitlistRemoveOK  = "候选已移出候补队列"
	MsgWaitlistExpireOK  = "逾期候选已顺延，下一位已进入确认期"
